...
const SingleCourse = ({course}) => {
    ...
    return (
        <div className='course-card p-6 border border-slate-100 relative'>
            {
                isActive && <div className='absolute inset-x-3/4 -inset-y-1    w-20'><p className='font-medium text-center text-white shadow-lg  bg-red-600 rounded-3xl '>Trending</p></div>
            }
